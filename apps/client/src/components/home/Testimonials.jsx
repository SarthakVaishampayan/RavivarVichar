...
export default function Testimonials() {
  ...
  const next = () => testimonials.length > 0 && setCurrent((prev) => (prev + 1) % testimonials.length);
  const prev = () => testimonials.length > 0 && setCurrent((prev) => (prev - 1 + testimonials.length) % testimonials.length);
      ...
      <div className="container-site">
        ...
        {testimonials.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-ink-secondary text-lg">No testimonials added yet.</p>
            <p className="text-sm text-ink-secondary/60 mt-1">Add the first testimonial from the admin panel.</p>
          </div>
        )}
      </div>
    </section>
