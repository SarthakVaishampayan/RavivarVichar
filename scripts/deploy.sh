...
echo ""
echo "  ─── Deploy Procedure (next time) ───"
echo "  cd /var/www/RavivarVichar"
echo "  MAINTENANCE_PASS=standbymode bash scripts/maintenance-on.sh"
echo "  bash scripts/deploy.sh"
echo "  bash scripts/maintenance-off.sh"
echo ""
